    ...
    <Form {...form}>
      ...
      >
        ...
        <CustomFormField
          ...
          label="I consent to receiving medical treatment, including procedures and follow-up care."
        />
        <CustomFormField
          fieldType={FormFieldType.CHECKBOX}
          control={form.control}
          name="disclosureConsent"
          label="I consent to the sharing of my health information for treatment, billing, and legal purposes."
        />
        <CustomFormField
          fieldType={FormFieldType.CHECKBOX}
          control={form.control}
